    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-counted-every-ecdsa-signature-ever-mined-to-work-out-what-low-r-grinding-has-actually-saved-written-up-in-what-grinding-has-actually-saved-on-chain",
          title: 'Counted every ECDSA signature ever mined to work out what low-r grinding has...',
          description: "",
          section: "News",},{id: "news-wrapped-up-my-summer-of-bitcoin-project-on-bdk-wallet-four-pull-requests-across-bdk-chain-and-bdk-wallet-all-still-under-review-teaching-the-wallet-to-decide-which-unconfirmed-coins-to-trust-by-following-where-the-money-came-from-instead-of-which-keychain-it-landed-on-the-whole-story-is-in-modifying-the-bdk-wallet-balance-api-for-my-summer-of-bitcoin-project",
          title: 'Wrapped up my Summer of Bitcoin project on bdk_wallet 🧡. Four pull requests...',
          description: "",
