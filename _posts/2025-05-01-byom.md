...
- **The network must remain _fully isolated_ from the internet** to prevent accidental synchronization with the real Bitcoin blockchain.
...
> 💭 You can experiment with `bitcoin.conf` settings [here :)](https://jlopp.github.io/bitcoin-core-config-generator/)
